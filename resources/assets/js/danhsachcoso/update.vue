          ...
          <div class="col-md-12 mb-4">
            <div class="form-group">
              ...
              <treeselect
                ...
                v-model="co_so_san_xuat.loai_nganh_nghe"
                value-format="object"
                v-validate="'required'"
                :show-count="true"
              >
...
export default {
  ...
  props: {
    ...
    chudautu: { type: Object | Array, default: () => {} },
    chudautus: { type: Array, default: () => [] },
    cososanxuat: { type: Object, default: () => {} },
    loai_hinh_co_so_tree_listing: { type: Array, default: () => [] },
    keyLoaiHinhCoSo: {
      type: String,
      default: "loai_nganh_nghe",
    },
  },
  data: () => ({
    khucongnghieps: [],
  ...
  mounted() {
    ...
    this.getDonVi();
    console.log("this.cososanxuat", this.cososanxuat);

    if (this.chudautu && this.chudautu instanceof Object) {
      this.chuDauTu = { ...this.chudautu };
    }
    for (const key in this.co_so_san_xuat) {
      this.co_so_san_xuat[key] = this.cososanxuat[key];
    }
  },
  methods: {
    getDonVi() {
      axios
        ...
        .then((response) => {
          ...
          this.co_so_san_xuat.don_vi_dien_tich =
            response.data.result.don_vi_goc.dien_tich;
          this.co_so_san_xuat.don_vi_nuoc_su_dung =
