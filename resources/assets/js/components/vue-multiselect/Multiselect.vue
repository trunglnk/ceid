    ...
    class="multiselect">
      ...
      <transition name="multiselect">
        <div
          ...
          tabindex="-1"
          @mousedown.prevent
          :style="{ maxHeight: optimizedHeight + 'px', top: maTop, height: 'fit-content'}"
          ref="list"
        >
          <ul ref="listContent" class="multiselect__content" :style="contentStyle">
...
export default {
  ...
  mounted() {
    if (this.$refs.selectRef) {
      this.$refs.list.style.width = this.$refs.selectRef.offsetWidth + 'px'
    } else {
      this.$refs.list.style.width = 300 + 'px'
    }
  }
}
</script>
