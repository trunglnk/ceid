@component('components.modal-add', [ 
    ...
    <div class="row">
        <div class="col-sm-12">
            <label for="role" class="control-label">{{__('field.role')}}<span style="color:red">*</span></label>
            ...
            <label for='menu' class="control-label">{{__('field.menu')}}<span style="color:red">*</span></label>
            ...
            @component('components.group-checkbox', [
                ...
                'id' => 'home_router',
                'name' => 'home_router',
                'title_active' => __('label.home_page'),
                'title_inactive' => __('label.normal_page'),
                'value_active' => 1,
                'value_inactive' => 0,
