...
@section('content')
    <div class="row">
      <div class="col-md-6 col-lg-5 block-multiple-rows">
          ...
          <form class="form-horizontal" method="POST" action="{{route('profile.update')}}">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <label for="name" class="control-label">{{__('field.username')}}</label>
                        ...
                        <label for="role" class="control-label">{{__('field.role')}}</label>  
            ...
            <div class="box-footer">                    
                <button type="submit" class="btn bg-orange btn-flat pull-right" tabindex="6">
                ...
                <a href="#" data-toggle="modal" data-target="{{'#modal-auth-changepassword-' . $user->id}}" class="btn bg-olive btn-flat" tabindex="5">
                    <i class="fa fa-undo"></i> {{__('button.change_password')}}
                </a>                
            </div>                                                
          </form>
