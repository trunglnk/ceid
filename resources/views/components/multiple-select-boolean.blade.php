<label>{{$label}}</label>
<select {{empty($id)?null:'id='.$id}} class="form-control select2 flat" multiple="multiple"  data-placeholder="{{isset($placeholder)? $placeholder : __('component.multiple-select.none')}}"
