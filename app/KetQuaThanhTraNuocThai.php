...
class KetQuaThanhTraNuocThai extends Model
{
    protected $fillable = [
        'luu_luong',
        'thanh_phan',
    ...
    public function setThongSoNuocThaiVuotChuanAttribute($value)
    {
        if (empty($value)) {
            $this->attributes['thong_so_nuoc_thai_vuot_chuan'] = 0;
        } else {
            $this->attributes['thong_so_nuoc_thai_vuot_chuan'] = str_replace(',', '', $value);
        }
    }
