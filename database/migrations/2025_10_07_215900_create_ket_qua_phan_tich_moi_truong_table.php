...
class CreateKetQuaPhanTichMoiTruongTable extends Migration
{
     public function up(): void
    {
        Schema::create('ket_qua_phan_tich_moi_truong', function (Blueprint $table) {
            ...
            $table->string('loai_moi_truong')->nullable()->comment('Phân loại môi trường: Nước thải / Nước mặt / Khí thải / Bùn thải / Không khí...');
    ...
    {
        Schema::dropIfExists('ket_qua_phan_tich_moi_truong');
    }
}
