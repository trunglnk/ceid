...
class CreateKetQuaThanhTraChatThaiRanSinhHoatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ket_qua_thanh_tra_chat_thai_ran_sinh_hoats', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('ket_qua_thanh_tra_chat_thai_ran_sinh_hoats');
    }
}
