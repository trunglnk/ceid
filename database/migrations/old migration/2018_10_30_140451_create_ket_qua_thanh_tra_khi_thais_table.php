...
class CreateKetQuaThanhTraKhiThaisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ket_qua_thanh_tra_khi_thais', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('nguon_tiep_nhan')->nullable();
    ...
    {
        Schema::dropIfExists('ket_qua_thanh_tra_khi_thais');
    }
}
